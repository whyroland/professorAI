    ...
    if (input.value.trim() != "") {
        jQuery.ajax({
            ...
            success: function (data) {
              ...
              insertlocation.innerHTML = "<div class='card" + shake + "'><div class='card-header'><h5 class='mb-0' style='font-size: 'Inter';'>The Professor Says...</h5></div><div class='card-body'><p class='card-text' style='font-family: 'Inter';'><strong>" + data + "</strong></p></div></div>";
            }
        });
