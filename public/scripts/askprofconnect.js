...
form.onsubmit = function (event) {
    ...
    jQuery.ajax({
        ...
        success: function (data) {
          console.log(data);
          insertlocation.innerHTML = "<div class='card jello animated'><div class='card-header'><h5 class='mb-0' style='font-size: 'Inter';'>The Professor Says...</h5></div><div class='card-body'><p class='card-text' style='font-family: 'Inter';'><strong>" + data + "</strong></p></div></div>";
        }
    });
